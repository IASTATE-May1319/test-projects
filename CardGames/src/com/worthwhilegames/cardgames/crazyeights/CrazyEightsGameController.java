...
public class CrazyEightsGameController implements GameController {
	 ...
	 *            GameController
	 */
	public CrazyEightsGameController(GameboardActivity context,	@NonNull ConnectionServer connectionGiven,
			@NonNull List<Player> playersGiven, ImageView refreshGiven) {
		gameContext = context;
