...
public class CrazyEightsTabletGame implements Game {
	 ...
	 */
	private @NonNull List<Player> players = new ArrayList<Player>();

	/**
	 * A private variable representing the game deck for the crazy eights game
	 */
	private @NonNull Deck gameDeck;
	 ...
	 */
	private @NonNull ArrayList<Card> shuffledDeck;

	/**
	 * A list of all the cards in the discard pile
	 */
	private @NonNull ArrayList<Card> discardPile;
	 ...
	 */
	public CrazyEightsTabletGame(@Nullable List<Player> players, @Nullable Deck gameDeck, Rules rules) {
	 ...
	 */
	@Override
	public @Nullable List<Player> getPlayers() {
		return players;
	}
	 ...
	 */
	@Override
	public void dropPlayer(@NonNull String playerMacAddress) {
		if (Util.isDebugBuild()) {
